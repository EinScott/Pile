...
namespace Pile
{
	public extension Window
	{
		...
		public override Monitor Monitor => Core.System.Monitors[0];
		...
		[SkipCall]
		protected internal override void Initialize(StringView name, uint32 width, uint32 height, WindowMode more)
		{
			title.Set(name);
