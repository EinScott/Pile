...
namespace SDL2
{
	public static class SDL
	{
		...
		*/
		...
		// @change This not only takes in profiles as values, also other ones!
		// was (SDL_GLAttr attr, SDL_GLProfile profile) before
		[LinkName("SDL_GL_SetAttribute")]
		public static extern int32 GL_SetAttribute(SDL_GLAttr attr, uint32 value);
